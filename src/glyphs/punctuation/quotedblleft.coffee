exports.glyphs['quotedblleft'] =
	...
	ot:
		advanceWidth: contours[2].nodes[3].x + spacingRight
	transforms: Array(
		['skewX', slant + 'deg'],
		['scaleX', - 1 ],
		['scaleY', - 1 ]
		['translateX', - contours[2].nodes[3].x - spacingRight ]
	...
	anchors:
		...
		1:
			x: contours[1].nodes[1].x + 60 + Math.min( 60, ( 60 / 85 ) * thickness )
			y: anchors[0].y
	contours:
		0:
			skeleton: false
		...
		3:
			...
			nodes:
				...
				2:
					...
					y: anchors[1].y - 40 - Math.min( thickness, 120 )
					type: 'smooth'
					expand: Object({
						width: Math.min( ( 18 / 85 ) * thickness, 18 )
						angle: 106 + 'deg'
