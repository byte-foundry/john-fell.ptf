			...
			nodes:
				0:
					x:
						...
						then Math.max( Math.min(anchors[0].x, anchors[2].min0.x), anchors[2].max0.x ) - ( 15 / 85 ) * thickness
				...
				1:
					x:
						if anchors[2].right == false
							...
							then anchors[2].baseRight.x - ( 15 / 85 ) * thickness * serifAperture
				...
				6:
					x:
						if anchors[2].left == false
							if anchors[2].serifAperture == true
							then anchors[2].baseLeft.x + ( 15 / 85 ) * thickness * serifAperture
